...
## 3.3 Data processing strategy & feature engineering
...
### 3.3.2 Recode coded fields into labelled ordered factors
...
### 3.3.3 Feature engineering: transparent proxy indices (for stratification/comparison)
...
2.  Developmental: GPA distributions are broadly stable across academic years, with a modest upward shift toward the “Good/Excellent” bands in the Graduated group.
...
6.  Moderation: Institutional support shows clearer alignment with GPA among non-poor students, while the association appears weaker and more volatile among poor-household students.
