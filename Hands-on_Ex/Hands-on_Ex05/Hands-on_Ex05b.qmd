...
grouped_ggcorrmat(
  ...
  annotation.args = list(
    ...
    title = "Correlogram for wine dataset",
    subtitle = str_wrap(
      "The measures are: alcohol, sulphates, fixed acidity, citric acid, chlorides, residual sugar, density, free sulfur dioxide and volatile acidity",
      width = 85
    ),
